...
### **Шаг 1: Подготовка структуры**
 1. **Создать папку проекта** со следующей структурой:
    + *Файл `README.md` для описание проекта*
...
### **Шаг 2: Настройка репозитория**
 ...
 `git add .`
 4. Проверить статус изменений `git status`
 5. Создать первый коммит с описанием `git commit -m "Initial commit: базовая структура проекта"`
